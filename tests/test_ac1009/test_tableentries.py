...
from ezdxf.dxffactory.legacy.tableentries import Layer, Linetype, Style, AppID, UCS
from ezdxf.dxffactory.legacy.tableentries import View, Viewport, DimStyle
