...
from ezdxf.entities.legacy.headervars import VARMAP
from . import tableentries
from ezdxf.entities.legacy import graphics, tableentries

from ezdxf.entities.legacy.layouts import DXF12Layouts, DXF12BlockLayout
