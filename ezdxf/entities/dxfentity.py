...
from ezdxf.tags.dxftag import cast_tag_value, DXFTag
...
class DXFEntity(object):
    ...
    #     private = ["DXFATTRIBS"]
    #     if item not in private and item in self.DXFATTRIBS:
    #         return self.get_dxf_attrib(item)
    #     super(DXFEntity, self).__getattribute__(item)
    #
    # def __setattr__(self, key, value):
    #     if key in self.DXFATTRIBS:
    #         return self.set_dxf_attrib(key, value)
    #     super(DXFEntity, self).__setattr__(key, value)
